...
export POOLING_MODE="pma1" # Can be "mean", "max", "cls", or "pma1" to "pma8"
export SEQ_LEN=256
export BSZ=128 # it was 64 but it does not run on my machine
...
torchrun --nproc_per_node=2  scripts/training/run_glue.py \

...
#SBATCH --ntasks=10
#SBATCH --mem=80G
#SBATCH --job-name=pixel-experiments-NER-ensemble-100
#SBATCH --output=/home2/s3919609/pixel-semantic/NER-results/pixel-experiments-NER-ensemble-100.out
...
# ignore conll_2003_en for now

# languages=(amh conll_2003_en hau ibo kin lug luo pcm swa wol yor zh)
languages=(wol yor)

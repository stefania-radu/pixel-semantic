...
#SBATCH --ntasks=10
#SBATCH --mem=80G
#SBATCH --job-name=pixel-experiments-NER-ensemble-102
#SBATCH --output=/home2/s3919609/pixel-semantic/NER-results/pixel-experiments-NER-ensemble-102.out

...
class SubmititTrainingArguments:
    ...
    training_config_name: Optional[str] = field(default=None, metadata={"help": "Name of the training config to use"}) # config file such as configs/training/fp16_apex_bs32.json

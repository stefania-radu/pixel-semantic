...
class PangoCairoTextRenderer(TextRenderingMixin):
    ...
    # map text characters to specific parts of the image (offset mapping)
    ...
    # render different types of inputs on the Cairo surface
    ...
    # handle rendering pairs of text (such as in a question-answering context or translation task)

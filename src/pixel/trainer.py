...
class PIXELTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        outputs = model(**inputs) # any number of extra named parameters given as a dict
...
class PIXELTrainerForQuestionAnswering(PIXELTrainer):
    ...
    def evaluate(self, eval_dataset=None, eval_examples=None, ignore_keys=None, metric_key_prefix: str = "eval"):
        ...
        if self.post_process_function is not None and self.compute_metrics is not None:
            eval_preds = self.post_process_function(eval_examples, eval_dataset, output.predictions) # convert output (start and end position of context) into actual text

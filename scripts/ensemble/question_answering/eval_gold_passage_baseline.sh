...
predictions_in="/home2/s3919609/pixel-semantic/scripts/ensemble/results/eval_common_predictions_best.json"
working_dir="/home2/s3919609/pixel-semantic/scripts/ensemble/results"

# Evaluation script.
# https://github.com/allenai/bi-att-flow/blob/master/squad/evaluate-v1.1.py
EVAL_SCRIPT="/projects/s3919609/Pixel-stuff/software/bi-att-flow/squad/evaluate-v1.1.py"

# Path to TyDi QA baseline code (used for splitting predictions into individual
# languages.
TYDIQA_REPO_DIR="/projects/s3919609/Pixel-stuff/tydiqa_goldp"
...
TYDIQA_GOLDP_DIR=/projects/s3919609/Pixel-stuff/tydiqa_goldp
TYDIQA_VERSION="1.1"
...
for lang in english-DO-NOT-AVERAGE arabic bengali finnish indonesian swahili korean russian telugu; do

...
#SBATCH --nodes=1
#SBATCH --mem=20GB
#SBATCH --job-name=std_monte_carlo_span_1
#SBATCH --output=/home2/s3919609/pixel-semantic/scripts/monte_carlo/results/span_experiment_1000/std_outputs_span_final_1.out
...
python scripts/monte_carlo/monte_carlo_experiments.py \
  ...
  --masking_cumulative_span_weights="1" \
  --span_mask \
  --max_seq_length=256 \
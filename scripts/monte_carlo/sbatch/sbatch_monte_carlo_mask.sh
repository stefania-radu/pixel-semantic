...
#SBATCH --nodes=1
#SBATCH --mem=20GB
#SBATCH --job-name=std_monte_carlo_mask_0.9
#SBATCH --output=/home2/s3919609/pixel-semantic/scripts/monte_carlo/results/mask_experiment_1000/std_outputs_mask_final_0.9.out
